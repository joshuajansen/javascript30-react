...
class App extends Component {
  componentDidMount() {
    document.querySelector("html").classList = "SlideOnScroll"
  ...
  render() {
    return (
      <div className="site-wrap">
        ...
        <img alt="Sliding" src="http://unsplash.it/400/400" className="align-left slide-in" />
        ...
        <img alt="Sliding" src="http://unsplash.it/400/401" className="align-right slide-in" />
        ...
        <img alt="Sliding" src="http://unsplash.it/200/500" className="align-left slide-in" />
        ...
        <img alt="Sliding" src="http://unsplash.it/400/400" className="align-right slide-in" />
